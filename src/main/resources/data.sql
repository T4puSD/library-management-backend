insert into account(id, email, pwd, active, role) values (1, 'admin@test.com', '123', 1, 'ADMIN'), (2, 'faculty@test.com', '123', 1, 'FACULTY'), (3, 'student@test.com', '123', 1, 'STUDENT');
...
insert into borrow_log(id, account_id, book_copy_id, created) values (1, 2, 2, NOW()), (2, 2, 4, NOW() - 1), (3, 3, 5, NOW() -1), (4, 3, 6, NOW() -2);